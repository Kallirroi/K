export const ItemMap = [
	...
	},
	{
		header: 'samtous.wtf',
		type: 'web design + dev',
		text: 'A restless portfolio as an archive of images.',
	...
	},
	{
		...
		type: 'design',
		text: 'The scope of this project was to support UBS publishing a multimedia, longform article. The content of the article is based on the previously published article of the T Brand Studio in the New York Times titled <a href="http://paidpost.nytimes.com/ubs/what-it-takes-to-be-human.html">"What it takes to be human"</a>. <p>My work on this project focused solely on the design, since the development would be done entirely from the client dev team.</p>',
